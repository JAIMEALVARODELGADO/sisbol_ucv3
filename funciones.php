...
function conectarbd()
{
  $conexion=pg_connect("host='127.0.0.1' port='5434' dbname='sisbolbd_uc' user='postgres' password='12996873'") or die('No se ha podido conectar: ' . pg_last_error());
  //$dbconn = pg_connect("host='127.0.0.1' port='5434' dbname='prueba' user='postgres' password='12996873'") or die('No se ha podido conectar: ' . pg_last_error());
  if(!$conexion){
